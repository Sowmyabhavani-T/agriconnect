  ...
  return (
    ...
    <div className="p-6 md:p-10 bg-gradient-to-br from-green-50 via-white to-green-100 min-h-screen">
      ...
      <div className="bg-white border border-green-300 w-full max-w-xl mx-auto rounded-2xl shadow-lg p-8 flex flex-col items-center text-center animate-fade-in">
        <FaCheckCircle className="text-green-600 text-6xl mb-3 animate-pop" />
        <h1 className="text-2xl md:text-3xl font-bold text-green-700">Payment Successful</h1>
        <p className="text-gray-600 mt-2">Thank you for your purchase at <span className="font-semibold text-green-700">AgriConnect</span>.</p>
        <button
      ...
      {/* Products Section */}
      <div className="mt-12">
        <AllProduct heading={'🛍️ Continue Shopping'} />
      </div>
